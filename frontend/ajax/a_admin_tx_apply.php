...
$result_action = admin_plan_withdrawal_inquiry_apply($tid);
$result['admin_plan_withdrawal_inquiry_apply'] = $result_action;
...
<div class="alert alert-success alert-dismissible mt10 col-sm-12 pull-left">
	...
	<h4 style="text-align:left;"><i class="icon fa fa-check"></i> tx '.$tid.' '.t_get_val('Success').'!</h4>
...
$result['action_descr'] = '
			<div class="alert alert-danger alert-dismissible mt10 col-sm-12 pull-left" style="text-align:left;">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                <h4 style="text-align:left;"><i class="icon fa fa-ban"></i> tx '.$tid.'  '.t_get_val('Error').'!</h4>
