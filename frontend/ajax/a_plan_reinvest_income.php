...
$plan_type = $_POST['pt']; //id плана
$topup_tx_id = $_POST['tid']; //id юзверя
...
$result['action_result'] = '<i class="icon fa fa-check margin-r-5"></i>'.t_get_val('Success').'';
			...
			$result['action_descr'] = '
			<div class="alert alert-success alert-dismissible mt10 col-sm-12">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                <h4><i class="icon fa fa-check"></i> '.t_get_val('Success').'!</h4>
...
$result['action_descr'] = '
			<div class="alert alert-danger alert-dismissible mt10 col-sm-12">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                <h4><i class="icon fa fa-ban"></i> '.t_get_val('Error').'!</h4>
